...
/// Local-storage key holding the composed device identity
/// (`<serial>-<discriminator>`) this box presents to the backend and shows on
/// screen. See `DeviceRegistrationHandler.resolveDeviceKey`.
const String kStbDeviceKeyKey = 'stb_device_key';
